...
final class ModuleApiDocs
{
    #[OA\Get(
        ...
        description: 'Cache 6 jam, ≤9 query per Definition of Done Fase 3 (+1 dari cek ModuleAccessService). Progress user digabung setelah tree diambil dari cache.',
        ...
        responses: [
            ...
            new OA\Response(response: 403, description: 'Journey terkunci (`JOURNEY_LOCKED`) atau module sebelumnya belum completed (`MODULE_LOCKED`)'),
