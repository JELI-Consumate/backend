...
final class OtpVerificationNotification extends Notification
{
    use Queueable;
    ...
    public function toMail(mixed $notifiable): MailMessage
    {
        return (new MailMessage)
            ...
            ->line('Gunakan kode berikut untuk memverifikasi email kamu:')
            ->line("**{$this->otp}**")
            ...
            ->line('Abaikan email ini jika kamu tidak merasa mendaftar.');
    }
}
